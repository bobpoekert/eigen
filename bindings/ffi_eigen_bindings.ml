...
module Bindings (F : Cstubs.FOREIGN) = struct
  ...
  module SPMAT_S = struct
    ...
    let ml_eigen_insertmany = foreign "c_eigen_spmat_s_insertmany" (ptr c_spmat_s @-> int64_t @-> ptr int64_t @-> ptr int64_t @-> ptr elt @-> returning void)
  ...
  module SPMAT_D = struct
    ...
    let ml_eigen_insertmany = foreign "c_eigen_spmat_d_insertmany" (ptr c_spmat_d @-> int64_t @-> ptr int64_t @-> ptr int64_t @-> ptr elt @-> returning void)
  ...
  module SPMAT_C = struct
    ...
    let ml_eigen_insertmany = foreign "c_eigen_spmat_c_insertmany" (ptr c_spmat_c @-> int64_t @-> ptr int64_t @-> ptr int64_t @-> ptr elt @-> returning void)
  ...
  module SPMAT_Z = struct
    ...
    let ml_eigen_insertmany = foreign "c_eigen_spmat_z_insertmany" (ptr c_spmat_z @-> int64_t @-> ptr int64_t @-> ptr int64_t @-> ptr elt @-> returning void)
