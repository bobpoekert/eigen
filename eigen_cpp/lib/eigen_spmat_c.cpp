...
void c_eigen_spmat_d_insertmany(c_spmat_c *cm, size_t len, INDEX *xs, INDEX *ys, spmat_c_elt *vs)
{
  spmat_c &m = c_to_eigen(cm);
  TripletIterator<spmat_c_elt> it = TripletIterator<spmat_c_elt>(len, xs, ys, vs);
